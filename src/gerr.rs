...
///
/// It contains generic error id, prefix, and generic error data.
///
/// ID can be supplied manually or automatically through [`Id`] trait.
///
/// Prefix can be supplied manually or automatically through [`Prefix`] trait.
///
/// Data can be supplied manually through methods: [`GErr::set_data`] or [`GErr::with_data`] to change data's type.
///
/// Error location is automatically generated through some methods.
///
/// It contains stack-trace if `backtrace` feature is enabled.
///
/// [`NoID`] is provided if you want no id and it implements trait `Id`.
///
/// [`NoPrefix`] is provided if you want no prefix and it implements trait `prefix`.
///
/// [`NoData`] is provided if you want no data and it will serde to null for json.
///
